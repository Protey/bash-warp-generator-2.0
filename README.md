...
```bash
bash <(wget --inet4-only -qO- https://raw.githubusercontent.com/Protey/bash-warp-generator-2.0/main/warp_generator.sh)
```
...
## Вариант 3: Replit
1. Тыкаем сюда: [![Run on Repl.it](https://repl.it/badge/github/replit/upm)](https://replit.com/new/github/Protey/bash-warp-generator)
2. Создаём аккаунт
3. Нажимаем кнопку **`Run`** вверху
4. После того, как конфиг сгенерируется, копируем его, либо скачиваем файлом по ссылке и импортируем в AmneziaVPN!👍

## Вариант 4: GitHub Codespaces
1. Переходим по ссылке: https://github.com/Protey/bash-warp-generator-2.0/codespaces
...
7. После завершения можно **удалить codespace**:  
   - Переходим в https://github.com/Protey/bash-warp-generator-2.0/codespaces
...
Взято из репозитория [ImMALWARE](https://github.com/ImMALWARE/bash-warp-generator)

...
```bash
bash <(wget --inet4-only -qO- https://raw.githubusercontent.com/Protey/bash-warp-generator/main/warp_generator.sh)
```
...
1. Переходим по ссылке: https://github.com/Protey/bash-warp-generator/codespaces
...
7. После завершения можно **удалить codespace**:  
   - Переходим в https://github.com/Protey/bash-warp-generator/codespaces
